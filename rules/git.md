...
Do not list file names or paths in the subject line. The commit history already records which files changed. The subject must describe the purpose or effect of the change, not enumerate its contents.
